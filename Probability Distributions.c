...
#include <stdlib.h>                //this is used as we had use the concept of dynamic memory
#include <math.h>              
#include <process.h>             // as we have create menu drive program 
#include <string.h>
...
int main()
{
	...
	case 1: /* Aman Saraogi (Median and Mode)*/
	{
		...
		system("COLOR FC");                     // changing the background color
		int i, j;
		int n, max = 0, k = 0, c = 1;
